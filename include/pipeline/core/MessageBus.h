...
// STOP_REQUESTED  — VideoRenderNode 请求 Pipeline 停止，Pipeline 只设置标志并唤醒 waitEOS
...
// STOP_REQUESTED 只由 Pipeline 监听线程记录并用于唤醒 waitEOS，
// 不在 MessageBus 线程中直接调用 Pipeline::stop()。
//
